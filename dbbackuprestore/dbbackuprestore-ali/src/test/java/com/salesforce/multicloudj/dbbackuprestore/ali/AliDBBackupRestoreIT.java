...
/**
 * Integration tests for Alibaba Cloud DB Backup Restore implementation. These tests use WireMock to
 * record/replay HTTP interactions with Alibaba Cloud HBR service.
 *
 * @since 0.2.25
 */
@Disabled(
    "Enable this test when you have Alibaba Cloud HBR credentials and want to record interactions")
  ...
  public static class HarnessImpl implements Harness {
    ...
    public AbstractDBBackupRestore createDBBackupRestoreDriver() {
      ...
      String accessKeySecret =
          System.getenv().getOrDefault("TABLESTORE_ACCESS_KEY_SECRET", "FAKE_ACCESS_KEY_SECRET");
