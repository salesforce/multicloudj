...
public class ProviderSupplierTest {
  ...
  void setup() {
    ...
    serviceLoaderStatic
        .when(() -> ServiceLoader.load(AbstractBlobStore.class))
    ...
    serviceLoaderStatic
        .when(() -> ServiceLoader.load(AbstractBlobClient.class))
        .thenReturn(serviceLoader1);
  ...
  void testBlobClientProviderFound() {
    ...
    AbstractBlobClient.Builder builder =
        ProviderSupplier.findBlobClientProviderBuilder("testClient");
    assertNotNull(builder);
  }
}
