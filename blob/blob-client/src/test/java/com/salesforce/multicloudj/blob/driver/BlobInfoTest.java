...
public class BlobInfoTest {
  ...
  void testBuilderWithoutTimestamp() {
    BlobInfo blobInfo = BlobInfo.builder().withKey("test-key").withObjectSize(1024L).build();
  ...
  void testEqualsWithNullTimestamp() {
    BlobInfo blobInfo1 = BlobInfo.builder().withKey("test-key").withObjectSize(1024L).build();
