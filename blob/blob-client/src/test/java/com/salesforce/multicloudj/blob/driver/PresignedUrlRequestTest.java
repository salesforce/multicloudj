...
public class PresignedUrlRequestTest {
  ...
  void testBuilderWithNullKmsKey() {
    ...
    PresignedUrlRequest request =
        PresignedUrlRequest.builder().key(key).duration(duration).type(type).kmsKeyId(null).build();
  ...
  void testBuilderWithEmptyKmsKey() {
    ...
    PresignedUrlRequest request =
        PresignedUrlRequest.builder().key(key).duration(duration).type(type).kmsKeyId("").build();
