...
public class ProviderSupplierTest {
  ...
  public void testProvider() {
    ...
    try (MockedStatic<ServiceLoader> serviceLoaderStatic = mockStatic(ServiceLoader.class)) {
      ...
      serviceLoaderStatic
          .when(() -> ServiceLoader.load(AsyncBlobStoreProvider.class))
          .thenReturn(serviceLoader);
      serviceLoaderStatic
          .when(() -> ServiceLoader.loadInstalled(AsyncBlobStoreProvider.class))
          .thenReturn(serviceLoader);
      ...
      AsyncBlobStoreProvider.Builder builder =
          ProviderSupplier.findAsyncBuilder(TestAsyncBlobStore.PROVIDER_ID);
