...
public class TestAsyncBlobStore extends AbstractAsyncBlobStore {
  ...
  protected CompletableFuture<DirectoryDownloadResponse> doDownloadDirectory(
    ...
    if (throwUnsupportedOperation) {
      throw new UnsupportedOperationException(
          "Directory download not supported in test implementation");
    }
    return CompletableFuture.completedFuture(null);
  }
  ...
  protected CompletableFuture<Void> doDeleteDirectory(String prefix) {
    if (throwUnsupportedOperation) {
      throw new UnsupportedOperationException(
          "Directory delete not supported in test implementation");
    }
    return CompletableFuture.completedFuture(null);
  }
  ...
  public static class Builder extends AsyncBlobStoreProvider.Builder {
    ...
    public TestAsyncBlobStore build() {
      return new TestAsyncBlobStore(
          getProviderId(), getBucket(), getRegion(), getCredentialsOverrider(), getValidator());
    }
  }
}
