...
public abstract class BlobClientBuilder<C, S extends SdkService> {
   ...
   *
   * @param socketTimeout The amount of time to wait for data to be transferred over an established,
   *     open connection before the connection is timed out. A duration of 0 means infinity, and is
   *     not recommended.
   * @return An instance of self
   */
   ...
   *
   * @param idleConnectionTimeout The maximum amount of time that a connection should be allowed to
   *     remain open while idle. Value must be a positive duration.
   * @return An instance of self
   */
   ...
   * @return An instance of self
   */
  public BlobClientBuilder<C, S> withCredentialsOverrider(
   ...
   * @return An instance of self
   */
  public BlobClientBuilder<C, S> withInitialReadBufferSizeInBytes(
   ...
   * @return An instance of self
   */
  public BlobClientBuilder<C, S> withTransferManagerThreadPoolSize(
      Integer transferManagerThreadPoolSize) {
   ...
   * @return An instance of self
   */
  public BlobClientBuilder<C, S> withTransferDirectoryMaxConcurrency(
      Integer transferDirectoryMaxConcurrency) {
  ...
  /**
   * Method to control whether system property values should be used for proxy configuration. When
   * set to false, system properties like http.proxyHost, http.proxyPort will be ignored.
   *
   * @param useSystemPropertyProxyValues Whether to use system property values for proxy
   *     configuration
   * @return An instance of self
   */
  public BlobClientBuilder<C, S> withUseSystemPropertyProxyValues(
