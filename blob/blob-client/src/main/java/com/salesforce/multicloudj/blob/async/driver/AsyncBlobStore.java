...
public interface AsyncBlobStore extends SdkService, AutoCloseable {
   ...
   */
  CompletableFuture<DownloadResponse> download(
   ...
   */
  CompletableFuture<MultipartUploadResponse> completeMultipartUpload(
   ...
   *
   * @param directoryDownloadRequest directoryDownloadRequest Wrapper, containing directory download
   *     data
   * @return Returns a DirectoryDownloadResponse object that contains metadata about the blob
   */
  CompletableFuture<DirectoryDownloadResponse> downloadDirectory(
   ...
   */
  CompletableFuture<DirectoryUploadResponse> uploadDirectory(
