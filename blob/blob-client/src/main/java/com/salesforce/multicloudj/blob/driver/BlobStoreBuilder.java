...
public abstract class BlobStoreBuilder<T extends SdkService> implements SdkProvider.Builder<T> {
   ...
   * @return An instance of self
   */
  public BlobStoreBuilder<T> withTransferManagerThreadPoolSize(
   ...
   * @return An instance of self
   */
  public BlobStoreBuilder<T> withTransferDirectoryMaxConcurrency(
   ...
   * @return An instance of self
   */
  public BlobStoreBuilder<T> withUseSystemPropertyProxyValues(
  ...
  /**
   * Method to control whether environment variable values (e.g., HTTP_PROXY, HTTPS_PROXY, NO_PROXY)
   * should be used for proxy configuration. When set to false, these environment variables will be
   * ignored.
   *
