...
public class BlobInfoIteratorTest {
  ...
  void testBlobInfoIteratorIncludesTimestamp() {
    ...
    S3Object s3Object1 =
        S3Object.builder().key("test-key-1").size(1024L).lastModified(timestamp1).build();

    S3Object s3Object2 =
        S3Object.builder().key("test-key-2").size(2048L).lastModified(timestamp2).build();

    ListObjectsV2Response response =
        ListObjectsV2Response.builder().contents(s3Object1, s3Object2).isTruncated(false).build();
  ...
  void testBlobInfoIteratorWithPrefix() {
    ...
    S3Object s3Object =
        S3Object.builder().key("prefix/test-key").size(1024L).lastModified(timestamp).build();
