...
public class AwsBlobClientTest {
  ...
  void testBuildS3ClientWithFixedRetryConfig() {
    ...
    var client =
        new AwsBlobClient.Builder().withRegion("us-east-2").withRetryConfig(fixedConfig).build();
  ...
  void testBuildS3ClientWithRetryConfigWithAttemptTimeout() {
    ...
    var client =
        new AwsBlobClient.Builder().withRegion("us-east-2").withRetryConfig(config).build();
