...
/**
 * Consumer that wraps another Consumer of a different type, and uses a conversion function to map
...
public class ConsumerWrapper<X, Y> implements Consumer<X> {
  ...
  /**
   * Accepts the supplied input type X, maps it to the target type Y and invokes the wrapped
   * consumer.
   *
