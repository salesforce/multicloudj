...
/**
 * An implementation of the {@link AbstractBlobClient} for AWS S3. AwsBlobClient is service client
...
public class AwsBlobClient extends AbstractBlobClient<AwsBlobClient> {
   ...
   *     representing the buckets in the current region for this account.
   */
  @Override
  ...
  private static S3Client buildS3Client(Builder builder) {
    ...
    if (builder.getProxyEndpoint() != null
      ...
      b.httpClient(
          ApacheHttpClient.builder().proxyConfiguration(proxyConfigBuilder.build()).build());
    }
