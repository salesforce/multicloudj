 ...
 *
 * <p>This decoder handles: - Primitive types (boolean, int, long, double, string) - Byte arrays -
...
public class SpannerDecoder implements Decoder {
  ...
  /**
   * Converts the Spanner Value into a Java object. This method handles all supported Spanner types
   * and converts them into their corresponding Java types.
   *
  ...
  /**
   * Converts a Spanner Value into a Java object. This method handles all supported Spanner types
   * and converts them into their corresponding Java types.
   *
