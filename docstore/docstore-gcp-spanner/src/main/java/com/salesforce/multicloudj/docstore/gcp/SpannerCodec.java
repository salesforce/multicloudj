 ...
 *
 * <p>This class handles the conversion of: - Java objects to Spanner Value types for storage -
 * Spanner Struct objects to Java objects for retrieval - Document fields to Spanner Value types for
 * updates
 */
public class SpannerCodec {

  /**
   * Encodes document key fields into a map of Spanner Values. This method is used to create primary
   * key and sort key fields for Spanner operations.
   *
   ...
   */
  public static Map<String, Value> encodeDocKeyFields(
      Document doc, String primaryKeyField, String sortKeyField) {
    Map<String, Value> m = new HashMap<>();
    Predicate<String> addFieldIfExists =
        fieldName -> {
  ...
  /**
   * Encodes a Java object into a Spanner Value type. This method uses the SpannerEncoder to convert
   * various Java types into their corresponding Spanner Value representations.
   *
  ...
  /**
   * Encodes a Document object into a map of Spanner Value types. This method converts all fields in
   * the Document into their corresponding Spanner Value representations.
   *
  ...
  /**
   * Decodes a Spanner Struct into a Document object. This method converts the Spanner Struct's
   * fields into a map and uses SpannerDecoder to populate the target Document.
   *
