...
class SpannerDecoderTest {
  ...
  void testDecode() {
    ...
    for (TestCase test : testCases) {
      ...
      Struct struct = Struct.newBuilder().set("value").to(value).build();
  ...
  void testDecodeMap() {
    ...
    Struct struct = Struct.newBuilder().set("a").to("b").set("c").to("d").build();
  ...
  @Test
  void testDecodeNull() {
    Struct struct = Struct.newBuilder().set("value").to(Value.string(null)).build();
