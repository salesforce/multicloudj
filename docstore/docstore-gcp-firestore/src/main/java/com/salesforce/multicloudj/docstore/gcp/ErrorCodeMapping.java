...
/**
 * Maps Google Cloud status codes to appropriate SubstrateSdkException types. This provides
 * consistent error handling across all GCP implementations.
 */
public class ErrorCodeMapping {

  private static final Map<StatusCode.Code, Class<? extends SubstrateSdkException>> EXCEPTION_MAP =
      new HashMap<>();
