...
public class FSDocumentIteratorTest {
  ...
  @Mock private FSDocStore mockDocStore;

  @Mock private QueryRunner mockQueryRunner;

  @Mock private ServerStream<RunQueryResponse> mockServerStream;

  @Mock private Iterator<RunQueryResponse> mockIterator;
  ...
  private com.google.firestore.v1.Document createFirestoreDocumentWithMultipleFields(
    ...
    return com.google.firestore.v1.Document.newBuilder()
        ...
        .putFields(
            field1, com.google.firestore.v1.Value.newBuilder().setStringValue(value1).build())
        .putFields(
            field2, com.google.firestore.v1.Value.newBuilder().setStringValue(value2).build())
        .build();
  }

  private RunQueryResponse createResponseWithDocument(String field, String value) {
    com.google.firestore.v1.Document firestoreDoc =
        com.google.firestore.v1.Document.newBuilder()
            .setName("projects/test/databases/(default)/documents/collection/doc1")
            .putFields(
                field, com.google.firestore.v1.Value.newBuilder().setStringValue(value).build())
            .build();
    return RunQueryResponse.newBuilder().setDocument(firestoreDoc).build();
  }
  ...
  void testNextWhenDocumentExists() {
    RunQueryResponse response =
        RunQueryResponse.newBuilder()
            .setDocument(
                createFirestoreDocumentWithMultipleFields(
  ...
  void testNextWhenNoMoreDocuments() {
    ...
    NoSuchElementException thrown =
        Assertions.assertThrows(NoSuchElementException.class, () -> iterator.next(doc));
  ...
  void testHasNextWhenFailedPreconditionExceptionWithoutIndexError() {
    ...
    FailedPreconditionException exception =
        new FailedPreconditionException(
            "FAILED_PRECONDITION: Some other error", null, mockStatusCode, false);
    ...
    FailedPreconditionException thrown =
        Assertions.assertThrows(FailedPreconditionException.class, iterator::hasNext);
