...
public class FieldCache {
  ...
  // This method returns all the public and private fields of a class type, including the fields
  // inherited.
  // Fields in the embedded class are ignored, such as static nested class, inner class, local
  // class, and anonymous class.
