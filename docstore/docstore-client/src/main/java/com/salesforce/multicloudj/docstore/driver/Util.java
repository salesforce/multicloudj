...
public class Util {
  ...
  public static void groupActions(
      List<Action> actions,
      List<Action> beforeGets,
      List<Action> getList,
      List<Action> writeList,
      List<Action> atomicWriteList,
      List<Action> afterGets) {
  ...
  private static void handleNullKeyAction(
      Action action, List<Action> nullKeys, List<Action> atomicNullKeys) {
  ...
  private static void handleGetAction(
      Action action,
      String keyStr,
      Map<String, Action> writes,
      Map<String, Action> atomicWrites,
      Map<String, Action> cgets,
  ...
  private static void handleWriteAction(
      Action action,
      String keyStr,
      Map<String, Action> cgets,
      Map<String, Action> bgets,
      Map<String, Action> writes,
      Map<String, Action> atomicWrites) {
