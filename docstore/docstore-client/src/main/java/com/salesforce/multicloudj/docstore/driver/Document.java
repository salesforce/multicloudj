...
/*
 * The Document class is a wrapper around the Map or the POJO defined by end user. End users should
 * not directly call the methods of the Document class, they should interact with the underlying
 * POJO or Map that the Document wraps.
 */
  ...
  private FieldInfo getFieldInfo(String fieldName) {
    ...
    int index =
        Collections.binarySearch(
            fieldList,
            new FieldInfo(fieldName, false, null, null),
