...
public class DocumentTest {
  ...
  public void testGetDocument() {
    ...
    */
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> docMap.getDocument(new String[] {"author", "badInput"}, true));
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> docObject.getDocument(new String[] {"author", "badInput"}, true));
  ...
  public void testSet() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> docMap.set(new String[] {"author", "initialis"}, "ZF"));
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> docObject.set(new String[] {"author", "initialis"}, "ZF"));
