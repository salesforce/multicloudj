...
public class UtilTest {
  ...
  public void testGroupActions() {
    ...
    TestAction nullKey =
        new TestAction(
            ActionKind.ACTION_KIND_CREATE, new Document(person), null, null, null, false);

    TestAction bget =
        new TestAction(ActionKind.ACTION_KIND_GET, new Document(person), "Ford", null, null, false);

    TestAction write =
        new TestAction(
            ActionKind.ACTION_KIND_UPDATE, new Document(person), "Ford", null, null, false);

    TestAction atomicWrite1 =
        new TestAction(
            ActionKind.ACTION_KIND_UPDATE, new Document(person), "Subaru", null, null, true);

    TestAction atomicWrite2 =
        new TestAction(
            ActionKind.ACTION_KIND_UPDATE, new Document(person), "Benz", null, null, true);

    TestAction cget =
        new TestAction(
            ActionKind.ACTION_KIND_GET, new Document(person), "TOYOTA", null, null, false);
  ...
  public void testGroupByFieldPath() {
    ...
    TestAction get1 =
        new TestAction(ActionKind.ACTION_KIND_GET, new Document(person), null, fp1, null, false);
    TestAction get2 =
        new TestAction(ActionKind.ACTION_KIND_GET, new Document(person), null, fp2, null, false);
    TestAction get3 =
        new TestAction(ActionKind.ACTION_KIND_GET, new Document(person), null, fp3, null, false);
    TestAction get4 =
        new TestAction(ActionKind.ACTION_KIND_GET, new Document(person), null, fp3, null, false);
    TestAction get5 =
        new TestAction(ActionKind.ACTION_KIND_GET, new Document(person), null, fp4, null, false);
    TestAction get6 =
        new TestAction(ActionKind.ACTION_KIND_GET, new Document(person), null, fp5, null, false);
  ...
  void testSerializeObject() {
    Person person =
        new Person(
            ...
            Timestamp.newBuilder().setNanos(100).build());
    String expected =
        "{\"nickNames\":[\"Jamie\"],\"firstName\":\"Zoe\","
            + "\"lastName\":\"Ford\","
            + "\"dateOfBirth\":\"1970-01-01T00:00:00.000000100Z\"}";
    Assertions.assertEquals(expected, Util.serializeObject(person));
