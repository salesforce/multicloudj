    ...
    List<TestCase> testCases =
        Arrays.asList(
            new TestCase(
                ...
                AttributeValue.builder().b(SdkBytes.fromByteArray(ts.toByteArray())).build(),
                ts),
            ...
            new TestCase(
                ...
                AttributeValue.builder()
                    .m(Map.of("b", AttributeValue.builder().n("1").build()))
                    .build(),
                Map.of("b", 1)),
            ...
            new TestCase(
                ...
                AttributeValue.builder()
                    .m(Map.of("b", AttributeValue.builder().s("c").build()))
                    .build(),
                Map.of("b", "c"))

            // nested map
            // new TestCase(new HashMap<String, HashMap<String, String>>(), Map.of("a", Map.of("b",
            // "c")), Map.of("a", Map.of("b", "c")))
            // new TestCase(new ArrayList<>(),
            // AttributeValue.builder().l(AttributeValue.builder().s("a").build(),
            // AttributeValue.builder().s("b").build()).build(), List.of("a", "b"))
            // new TestCase((new String[]{}), AttributeValue.builder().l(new
            // ArrayList<>(List.of(AttributeValue.builder().s("Volvo").build(),
            //                        AttributeValue.builder().s("BMW").build(),
            //                        AttributeValue.builder().s("Ford").build(),
            //                        AttributeValue.builder().s("Mazda").build()))).build(), new
