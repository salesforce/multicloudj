...
public class AwsStsTest {
  ...
  public static void setUp() {
    ...
    AssumeRoleWithWebIdentityResponse webIdentityResponse =
        AssumeRoleWithWebIdentityResponse.builder().credentials(credentials).build();
    GetSessionTokenResponse sessionTokenResponse =
        GetSessionTokenResponse.builder().credentials(credentials).build();
    GetCallerIdentityResponse callerIdentityResponse =
        GetCallerIdentityResponse.builder()
            .userId("testUserId")
            .arn("testResourceName")
            .account("testAccountId")
            .build();
    Mockito.when(mockStsClient.assumeRole(any(AssumeRoleRequest.class))).thenReturn(mockResponse);
    Mockito.when(
            mockStsClient.assumeRoleWithWebIdentity(any(AssumeRoleWithWebIdentityRequest.class)))
        .thenReturn(webIdentityResponse);
    Mockito.when(mockStsClient.getSessionToken(any(GetSessionTokenRequest.class)))
        .thenReturn(sessionTokenResponse);
    Mockito.when(mockStsClient.getCallerIdentity(any(GetCallerIdentityRequest.class)))
  ...
  public void testAssumeRoleWithCredentialScope() throws Exception {
    ...
    org.mockito.ArgumentCaptor<AssumeRoleRequest> captor =
