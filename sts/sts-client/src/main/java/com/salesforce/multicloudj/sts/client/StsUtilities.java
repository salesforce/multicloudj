...
/**
 * StsUtilities class provides portable offline Utility functions which utilize the Security Token
 * Service (STS) in a substrate agnostic way.
 */
public class StsUtilities {
   ...
   */
  private static AbstractStsUtilities.Builder<?> createBuilderInstance(
      AbstractStsUtilities<?> provider) {
    try {
      return (AbstractStsUtilities.Builder<?>)
  ...
  public static class StsUtilityBuilder {
     ...
     *
     * @param credentialsOverrider The credentialsOverrider overrider to supply the
