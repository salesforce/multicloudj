...
public class TestConcreteAbstractStsUtilities
    extends AbstractStsUtilities<TestConcreteAbstractStsUtilities> {
  ...
  public static class Builder
      extends AbstractStsUtilities.Builder<TestConcreteAbstractStsUtilities> {
    protected Builder() {
