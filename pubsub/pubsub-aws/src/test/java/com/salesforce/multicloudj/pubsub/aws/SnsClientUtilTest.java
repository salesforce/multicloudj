...
public class SnsClientUtilTest {
  ...
  void testBuildSnsClient_WithCredentialsOnly() {
    ...
    credentialsProviderStatic
        .when(
            () ->
                CredentialsProvider.getCredentialsProvider(any(CredentialsOverrider.class), any()))
    ...
    credentialsProviderStatic.verify(
        () -> CredentialsProvider.getCredentialsProvider(credentialsOverrider, null));
  ...
  void testBuildSnsClient_WithAllParameters() {
    ...
    verify(mockBuilder).endpointOverride(endpoint);
    credentialsProviderStatic.verify(
        () -> CredentialsProvider.getCredentialsProvider(credentialsOverrider, Region.of(region)));
    verify(mockBuilder).credentialsProvider(mockCredentialsProvider);
    verify(mockBuilder).build();
  }
  ...
  void testBuildSnsClient_WithAssumeRoleCredentials() {
    ...
    URI endpoint = null;
    CredentialsOverrider credentialsOverrider =
        new CredentialsOverrider.Builder(CredentialsType.ASSUME_ROLE).withRole("test-role").build();
