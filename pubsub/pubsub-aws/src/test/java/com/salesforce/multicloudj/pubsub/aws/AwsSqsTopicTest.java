...
public class AwsSqsTopicTest {
  ...
  void setUp() {
    ...
    GetQueueAttributesResponse mockAttributesResponse =
  ...
  void testSend() {
    ...
    SendMessageBatchResponse mockResponse =
        SendMessageBatchResponse.builder().successful(List.of()).failed(List.of()).build();
