  ...
  public static class HarnessImpl implements Harness {
    ...
    public AbstractSubscription createSubscriptionDriver() {
      throw new UnsupportedOperationException(
          "SNS does not support receiving messages. Use AwsPubsubSqsIT for receive/ack/nack"
              + " tests.");
    }
    ...
    public List<String> getWiremockExtensions() {
      return List.of(
          "com.salesforce.multicloudj.pubsub.aws.util.PubsubReplaceAuthHeaderTransformer");
    }
