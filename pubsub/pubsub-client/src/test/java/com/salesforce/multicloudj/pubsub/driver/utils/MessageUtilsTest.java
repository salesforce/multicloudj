...
public class MessageUtilsTest {
  ...
  public void testValidateMessage_ValidMessage() {
    // Arrange
    Message message =
        Message.builder().withBody("test content".getBytes()).withMetadata("key", "value").build();
  ...
  public void testValidateMessage_NullMessage() {
    ...
    InvalidArgumentException exception =
        assertThrows(InvalidArgumentException.class, () -> MessageUtils.validateMessage(null));
  ...
  public void testValidateMessage_NullBody() {
    // Arrange
    Message message =
        Message.builder().withMetadata("key", "value").build(); // Body is null by default

    // Act & Assert
    InvalidArgumentException exception =
        assertThrows(InvalidArgumentException.class, () -> MessageUtils.validateMessage(message));
  ...
  public void testValidateMessage_ValidMetadata() {
    ...
    Message message = Message.builder().withBody("test".getBytes()).withMetadata(metadata).build();
  ...
  public void testValidateMessage_ValidMetadataWithControlCharacters() {
    ...
    metadata.put(
        "key\twith\ttabs",
        // Control characters should be allowed
  ...
  public void testValidateMessageBatch_NullList() {
    // Act & Assert
    InvalidArgumentException exception =
        assertThrows(InvalidArgumentException.class, () -> MessageUtils.validateMessageBatch(null));
  ...
  public void testValidateMessageBatch_NullMessageInBatch() {
    ...
    InvalidArgumentException exception =
        assertThrows(
            InvalidArgumentException.class, () -> MessageUtils.validateMessageBatch(messages));
  ...
  public void testValidateMessageBatch_InvalidMessageInBatch() {
    ...
    List<Message> messages =
        Arrays.asList(Message.builder().withBody("message1".getBytes()).build(), invalidMessage);
  ...
  public void testCalculateByteSize_ValidMessage() {
    ...
    Message message =
        Message.builder().withBody(bodyContent.getBytes()).withMetadata(metadata).build();
  ...
  public void testCalculateByteSize_BodyOnlyMessage() {
    ...
    Message message = Message.builder().withBody(bodyContent.getBytes()).build();
  ...
  public void testCalculateByteSize_EmptyBody() {
    // Arrange
    Message message = Message.builder().withBody(new byte[0]).build();
