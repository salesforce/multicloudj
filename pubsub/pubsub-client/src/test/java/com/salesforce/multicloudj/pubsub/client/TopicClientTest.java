...
public class TopicClientTest {
  ...
  @Mock private AbstractTopic mockTopic;

  @Mock private AbstractTopic.Builder mockBuilder;
  ...
  public void testBuilderWithAllMethods() {
    try (MockedStatic<ProviderSupplier> mockedStatic = mockStatic(ProviderSupplier.class)) {
      // Arrange
      mockedStatic
          .when(() -> ProviderSupplier.findTopicProviderBuilder("test-provider"))
      ...
      // Act
      TopicClient result =
          TopicClient.builder("test-provider")
