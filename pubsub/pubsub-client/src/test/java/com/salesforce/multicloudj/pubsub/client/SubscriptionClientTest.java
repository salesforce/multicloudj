...
public class SubscriptionClientTest {
  ...
  @Mock private AbstractSubscription mockSubscription;

  @Mock private AbstractSubscription.Builder mockBuilder;
  ...
  public void testGetAttributes() {
    // Arrange
    GetAttributeResult expectedAttributes =
        new GetAttributeResult.Builder().name("test-subscription").topic("test-topic").build();
