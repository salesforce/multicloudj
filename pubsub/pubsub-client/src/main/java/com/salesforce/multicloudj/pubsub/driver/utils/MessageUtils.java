 ...
 *
 * <p>This class provides utility methods for message validation that can be used by any topic or
  ...
  public static void validateMessage(Message message) {
    ...
    if (message.getLoggableID() != null) {
      throw new InvalidArgumentException(
          "LoggableID cannot be set on outgoing messages. This field is reserved for received"
              + " messages and is set internally by drivers.");
    }
