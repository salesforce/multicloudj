 ...
 *
 * @see <a href="https://github.com/opencontainers/image-spec/blob/v1.0.1/manifest.md">OCI Image
...
public final class Manifest {
  ...
  private Manifest(
      ...
      List<IndexEntry> indexManifests,
      boolean index,
      String digest,
  ...
  public static Manifest image(
    ...
    List<String> digests =
        layerInfos != null
            ? layerInfos.stream().map(LayerInfo::getDigest).collect(Collectors.toList())
            : null;
    return new Manifest(
        configDigest, digests, layerInfos, null, false, digest, annotations, subject);
  }
