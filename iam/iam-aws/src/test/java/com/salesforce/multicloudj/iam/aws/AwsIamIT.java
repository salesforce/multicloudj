...
public class AwsIamIT extends AbstractIamIT {
  ...
  public static class HarnessImpl implements AbstractIamIT.Harness {
    ...
    public AbstractIam createIamDriver() {
      ...
      return new AwsIam.Builder().withIamClient(client).withRegion("us-west-2").build();
    }
     ...
     */
    private static final String TEST_POLICY_RESOURCE =
        "arn:aws:s3:::multicloudj-iam-it-test-bucket/*";
