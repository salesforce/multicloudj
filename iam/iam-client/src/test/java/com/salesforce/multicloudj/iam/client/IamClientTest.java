...
public class IamClientTest {
  ...
  void setup() {
    ...
    client =
        IamClient.builder(TEST_PROVIDER_ID)
  ...
  void testAttachInlinePolicyThrowsException() {
    ...
    doThrow(RuntimeException.class)
        .when(mockIam)
        .attachInlinePolicy(any(AttachInlinePolicyRequest.class));
  ...
  void testGetIdentity() {
    when(mockIam.getIdentity(anyString(), anyString(), anyString())).thenReturn(TEST_IDENTITY_ARN);
  ...
  void testBuilderWithRealProvider() {
    ...
    IamClient testClient =
        IamClient.builder("mockProviderId")
            .withRegion(TEST_REGION)
            .withEndpoint(TEST_ENDPOINT)
            .build();
  ...
  void testBuilderWithCredentialsOverrider() {
    ...
    when(testBuilder.withCredentialsOverrider(any(CredentialsOverrider.class)))
  ...
  void testFindProviderBuilderNoMatch() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> IamClient.builder("nonexistent-provider"));
    assertEquals(
        "No IAM provider found for providerId: nonexistent-provider", exception.getMessage());
  }
}
