...
public class TrustConfigurationTest {
  ...
  public void testTrustConfigurationBuilder() {
    ...
    List<String> expectedPrincipals =
        Arrays.asList(
            "arn:aws:iam::123456789012:root", "service-account@project.iam.gserviceaccount.com");
  ...
  public void testTrustConfigurationBuilderMinimal() {
    TrustConfiguration trustConfig =
        TrustConfiguration.builder().addTrustedPrincipal("arn:aws:iam::987654321098:root").build();

    assertEquals(
        Arrays.asList("arn:aws:iam::987654321098:root"), trustConfig.getTrustedPrincipals());
  ...
  public void testTrustConfigurationBuilderComplexScenario() {
    TrustConfiguration trustConfig =
        TrustConfiguration.builder()
            ...
            .addTrustedPrincipal(
                "service-account@project.iam.gserviceaccount.com") // GCP service account
  ...
  public void testNullAndEmptyValueHandling() {
    ...
    assertEquals(
        "us-west-2", trustConfig.getConditions().get("StringEquals").get("aws:RequestedRegion"));
  }
}
