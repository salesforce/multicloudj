...
/**
 * Identity defines the contract for IAM operations across cloud providers. This interface
 * represents the provider-agnostic API for managing identities (roles, service accounts, etc.) and
