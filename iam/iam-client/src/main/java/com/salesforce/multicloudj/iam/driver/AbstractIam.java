...
/**
 * Abstract base class for Identity and Access Management (IAM) implementations. This class is
 * internal for SDK and all the providers for IAM implementations are supposed to implement it.
 *
 * <p>This provides a unified interface for managing identities (roles/service accounts) and
 * policies across different cloud providers including AWS IAM, GCP IAM, and AliCloud RAM.
 */
public abstract class AbstractIam implements Provider, Identity, AutoCloseable {
  ...
  /**
   * Constructs an AbstractIam instance with specified provider ID, region, and credentials
   * overrider.
   *
   ...
   */
  public abstract static class Builder<A extends AbstractIam, T extends Builder<A, T>>
      implements Provider.Builder {
    @Getter protected String region;
    @Getter protected URI endpoint;
    @Getter protected CredentialsOverrider credentialsOverrider = null;
  ...
  /**
   * Creates a new identity (role/service account) in the cloud provider. Provider-specific
  ...
  /**
   * Attaches an inline policy to an identity. Provider-specific implementations should override
   * this method.
   *
   * @param request the request containing policy document, tenant ID, region, and identity/role
   *     names
   */
  protected abstract void doAttachInlinePolicy(AttachInlinePolicyRequest request);

  /**
   * Retrieves the details of a specific inline policy attached to an identity. Provider-specific
   * implementations should override this method.
   *
  ...
  /**
   * Lists all inline policies attached to an identity. Provider-specific implementations should
  ...
  /**
   * Removes an inline policy from an identity. Provider-specific implementations should override
   * this method.
   *
  ...
  /**
   * Deletes an identity from the cloud provider. Provider-specific implementations should override
   * this method.
   *
  ...
  /**
   * Retrieves metadata about an identity. Provider-specific implementations should override this
   * method.
   *
   * @param request the request containing identity name, tenant ID, and region
