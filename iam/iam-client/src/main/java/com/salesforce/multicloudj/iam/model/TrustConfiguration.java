 ...
 * AWS: ARN format (arn:aws:iam::account:type/name) - GCP: Email format
 * (serviceaccount@project.iam.gserviceaccount.com) - AliCloud: ACS format
 * (acs:ram::account:type/name) or account ID
 */
@Getter
public class TrustConfiguration {
  ...
  public static class Builder {
     ...
     *
     * @param principal the principal identifier in cloud-native format (AWS ARN, GCP email,
     *     AliCloud ACS ARN or account ID)
     ...
     * @param key the condition key in cloud-native format (e.g., "aws:RequestedRegion",
     *     ""aws:SourceIp")
